...
public function Send_reminder_automatic_pending() {
    ...
    // Query to retrieve all comp_id from the tbl_company table
    $comp_query = $this->db->query("SELECT comp_id FROM tbl_company");
    $comp_ids = $comp_query->result();

    // Loop through each comp_id
    foreach ($comp_ids as $comp) {
        $comp_id = $comp->comp_id;

        // Main query using the retrieved comp_id
